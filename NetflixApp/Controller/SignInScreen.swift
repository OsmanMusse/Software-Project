...
class SignInScreen: UIViewController, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "left-arrow").withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleBackBtn))
