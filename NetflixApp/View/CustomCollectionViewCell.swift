...
class CustomCollectionViewCell: UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    var videoInfo: [VideoData] = {
        ...
        video2.Image = UIImage(named:"suits")
        
        var video3 = VideoData()
        video3.Image = UIImage(named:"bodyguard")
        
        var video4 = VideoData()
        video4.Image = UIImage(named:"suits")
    ...
    func configure(){
        customCollectionView.register(InnerCustomCell.self, forCellWithReuseIdentifier: cellId)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = customCollectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! InnerCustomCell
...
class InnerCustomCell: UICollectionViewCell {
    ...
    var videoData: VideoData?{
        didSet{
            cellImage.image = videoData?.Image
